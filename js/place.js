 ...
 */
function updatePageMeta({ title, description, image = 'assets/images/After_ENV_01.png' }) {
...
function renderPlace(place) {
  ...
  updatePageMeta({
    ...
    image: place.afterImage || 'assets/images/After_ENV_01.png',
  });
  ...
  container.innerHTML = `
    ...
    <section class="max-w-6xl mx-auto px-4 sm:px-6 pb-16 sm:pb-20">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
        <!-- Teachers -->
        <div class="fade-in-section bg-white/70 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-sage/20 card-shadow">
          <div class="flex items-center gap-3 mb-5">
            <span class="flex items-center justify-center w-11 h-11 rounded-2xl bg-sage/20 text-forest">
            ...
            <h3 class="font-heading font-bold text-lg text-forest">Teachers</h3>
          </div>
          ${renderChips(place.teachers)}
        </div>

        <!-- Students -->
        <div class="fade-in-section bg-white/70 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-sage/20 card-shadow" style="transition-delay: 0.1s">
          <div class="flex items-center gap-3 mb-5">
            <span class="flex items-center justify-center w-11 h-11 rounded-2xl bg-sage/20 text-forest">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <h3 class="font-heading font-bold text-lg text-forest">Students</h3>
          </div>
          ${renderChips(place.students)}
        </div>

        <!-- OGA Members -->
        <div class="fade-in-section bg-white/70 backdrop-blur-sm rounded-3xl p-6 sm:p-8 border border-sage/20 card-shadow" style="transition-delay: 0.2s">
          <div class="flex items-center gap-3 mb-5">
            <span class="flex items-center justify-center w-11 h-11 rounded-2xl bg-sage/20 text-forest">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <h3 class="font-heading font-bold text-lg text-forest">OGA Members</h3>
          </div>
